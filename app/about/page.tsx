          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center">
              ...
              <p className="mb-6 text-muted-foreground">
                Founded by Cole Doerksen, Seasonal Solutions has been serving the Winnipeg community with professional
                handyman and landscaping services. Our team of skilled professionals is dedicated to delivering
            ...
            <div className="relative h-[300px] overflow-hidden rounded-lg sm:h-[400px] lg:h-full">
              <Image
                src={getUnsplashImage("about") || "/placeholder.svg"}
      ...
      <section className="py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              Our founder, Cole Doerksen, began his career in construction and landscaping with a passion for quality
              workmanship. After working for various companies, he noticed a gap in the market for a service provider
              that could handle both interior and exterior projects with the same level of care and expertise. This
              insight led to the creation of Seasonal Solutions.
            </p>
      ...
      <section className="bg-muted py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="relative h-[300px] overflow-hidden rounded-lg sm:h-[400px] lg:h-full">
              <Image
                src={getUnsplashImage("quality") || "/placeholder.svg"}
