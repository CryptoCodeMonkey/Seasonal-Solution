  ...
  const services = [
    {
      ...
      image: getUnsplashImage("landscaping", 600, 400),
    },
    {
      id: "handyman",
      ...
      image: getUnsplashImage("handyman", 600, 400),
    },
    {
      id: "painting",
      ...
      image: getUnsplashImage("painting", 600, 400),
    },
    {
      id: "renovation",
      ...
      image: getUnsplashImage("renovation", 600, 400),
    },
    {
      id: "seasonal",
      ...
      image: getUnsplashImage("seasonal", 600, 400),
    },
  ]
    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        <div className="absolute inset-0 z-0">
          <Image
            src={getUnsplashImage("handyman,landscaping,services", 1920, 600) || "/placeholder.svg"}
      ...
      <section className="relative py-16 lg:py-24">
        <div className="absolute inset-0 z-0">
          <Image
            src={getUnsplashImage("landscaping,garden,beautiful", 1920, 800) || "/placeholder.svg"}
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold tracking-tight text-white sm:text-4xl">Ready to Get Started?</h2>
            <p className="mb-8 text-xl text-white/90">
